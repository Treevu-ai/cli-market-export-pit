...
const integrations: Integration[] = [
  { name: "Arándano", category: "PE→US, EU", query: "arándano orgánico", market: "US", Icon: Grape, family: "frutasFrescas", hsCode: "081040", exclusive: true },
  { name: "Cacao", category: "PE→EU, US", query: "cacao alto flavanol", market: "US", Icon: FlaskConical, family: "derivadosFuncionales", hsCode: "180610", exclusive: true },
  { name: "Quinua", category: "PE→US, EU", query: "quinua orgánica", market: "EU", Icon: Wheat, family: "granosSemillas", hsCode: "100850", exclusive: true },
  { name: "Palta", category: "PE→EU, US", query: "palta hass", market: "US", Icon: Leaf, family: "frutasFrescas", hsCode: "080440", exclusive: true },
  { name: "Mango", category: "PE→US, EU", query: "mango kent", market: "US", Icon: Citrus, family: "frutasFrescas", hsCode: "080450", exclusive: true },
  ...
  { name: "Café", category: "PE→US, EU", query: "café tostado especial", market: "US", Icon: Coffee, family: "bebidasEstimulantes", hsCode: "090121", exclusive: true },
  { name: "Uva", category: "PE→US, EU", query: "uva red globe", market: "US", Icon: Grape, family: "frutasFrescas", hsCode: "080610", exclusive: true },
  { name: "Mandarina", category: "PE→US, EU", query: "mandarina w murcott", market: "US", Icon: Citrus, family: "frutasFrescas", hsCode: "080520", exclusive: true },
  { name: "Pisco", category: "PE→US, EU", query: "pisco puro quebranta", market: "US", Icon: Wine, family: "bebidasEstimulantes", hsCode: "220820", exclusive: true },
  { name: "Maca", category: "PE→US, EU", query: "maca negra gelatinizada", market: "US", Icon: Pill, family: "vegetalesRaices", hsCode: "121190", exclusive: true },
  { name: "Kiwicha", category: "PE→US, EU", query: "kiwicha organica", market: "US", Icon: Wheat, family: "granosSemillas", hsCode: "100890", exclusive: true },
  { name: "Camu camu", category: "PE→EU, US", query: "camu camu pulpa congelada", market: "US", Icon: Cherry, family: "derivadosFuncionales", hsCode: "081190", exclusive: true },
  { name: "Chía", category: "PE→US, EU", query: "semillas de chia organica", market: "US", Icon: Nut, family: "granosSemillas", hsCode: "120799", exclusive: true },
  { name: "Alcachofa", category: "PE→EU, US", query: "alcachofa en conserva", market: "US", Icon: Flower2, family: "vegetalesRaices", hsCode: "070991", exclusive: true },
  { name: "Ají panca", category: "PE→US, EU", query: "ají panca deshidratado", market: "US", Icon: Flame, family: "especiasAromaticas", hsCode: "090421", exclusive: true },
  { name: "Espárrago", category: "PE→US, EU", query: "espárrago fresco", market: "US", Icon: Sprout, family: "vegetalesRaices", hsCode: "070920", exclusive: true },
  { name: "Banano", category: "PE→EU, US", query: "banano orgánico", market: "EU", Icon: Leaf, family: "frutasFrescas", hsCode: "080390", exclusive: true },
  { name: "Limón", category: "PE→US, EU", query: "limón sutil", market: "US", Icon: Citrus, family: "frutasFrescas", hsCode: "080550", exclusive: true },
  { name: "Páprika", category: "PE→US, EU", query: "paprika molida", market: "US", Icon: Flame, family: "especiasAromaticas", hsCode: "090422", exclusive: true },
  { name: "Aguaymanto", category: "PE→US, EU", query: "aguaymanto deshidratado", market: "US", Icon: CircleDot, family: "frutasFrescas", hsCode: "081090", exclusive: false },
  { name: "Cúrcuma", category: "PE→US, EU", query: "curcuma en polvo organico", market: "US", Icon: Sparkles, family: "especiasAromaticas", hsCode: "091030", exclusive: true },
  { name: "Higo", category: "PE→US, EU", query: "higos frescos", market: "US", Icon: TreeDeciduous, family: "frutasFrescas", hsCode: "080420", exclusive: true },
  { name: "Maracuyá", category: "PE→EU, US", query: "pulpa de maracuya", market: "EU", Icon: Citrus, family: "derivadosFuncionales", hsCode: "200899", exclusive: false },
];
